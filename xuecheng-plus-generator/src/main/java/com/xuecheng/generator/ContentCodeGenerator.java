...
public class ContentCodeGenerator {
	...
	//数据库密码
	private static final String DATA_SOURCE_PASSWORD  = "2002726+abc";
	//生成的表
...
//			 "course_publish_pre"
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://47.108.238.142:3307/xcplus"
